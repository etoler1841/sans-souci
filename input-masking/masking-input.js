...
var inputMask = {
  ...
  createShell : function (t) {
    ...
    mask.appendChild(pattern);
    // mask.getElementsByTagName("i")[0].innerText = pTxt;
    // mask.innerText(placeholder);
  ...
  setValueOfMask : function (e) {
    ...
    return "<span style='display: none;'>" + value + placeholder.substr(value.length) + "</span>";
  },
  ...
  handleValueChange : function (e) {
    ...
    if(e.target.value == document.querySelector('#' + id + 'Mask span').innerHTML) {
